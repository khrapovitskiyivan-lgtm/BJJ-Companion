-- Расширение белого списка телеметрии: starter_open
-- (открытие вкладки «Старт» / стартового набора новичка).
...
-- Открытия стартового набора:
-- select count(*) from public.bjj_events where event = 'starter_open';
