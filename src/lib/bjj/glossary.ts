...
export const GLOSSARY: GlossaryTerm[] = [
  ...
  { term: "Ситбелт", en: "Seatbelt", category: "control", definition: "Захват накрест при контроле спины: одна рука над плечом соперника, другая под его подмышкой. Назван по аналогии с ремнём безопасности в машине. Держит спину надёжнее крюков." },
  { term: "Восьмёрка", en: "Figure-Four", category: "control", definition: "Замок рук или ног в форме восьмёрки: захватываешь конечность соперника и замыкаешь на своём запястье. Даёт двойной рычаг. Основа кимуры, американы, тохолда и хилхука." },
  ...
  { term: "Проход коленом", en: "Knee Cut, Knee Slice", category: "movement", definition: "Проход гарда, когда колено врезается через бедро соперника внутрь, а корпус прижимает его к ковру. Один из базовых проходов в кимоно и без." },
