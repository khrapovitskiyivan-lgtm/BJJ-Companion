...
export const GLOSSARY: GlossaryTerm[] = [
  ...
  { term: "Отворот, лапел", en: "Lapel", category: "control", definition: "Край куртки-ги вдоль груди и ключицы. Захват отворота — база удушений в ги (крестовое, бейсбол, лук-стрела) и лапель-гардов (ворм-гард, лапел-гард). Сленг: лапель, ляпель." },
