...
export const GLOSSARY: GlossaryTerm[] = [
  ...
  { term: "Бэк, бэк контроль, бэк тейк", en: "Back Control / Back Take", category: "positions", definition: "Контроль со спины соперника с крюками ногами (в зале: «взять спину»; «бэк тейк» — сам вход в позицию, он же выход на бэк контроль). Лучшая позиция в BJJ: атакуешь, оставаясь недосягаемым." },
  ...
  { term: "Отворот", en: "Lapel", category: "control", definition: "Край куртки-ги вдоль груди и ключицы. Захват отворота — база удушений в ги (крестовое, бейсбол, лук-стрела) и лапель-гардов (ворм-гард, лапел-гард). Сленг сообщества: лапель, ляпель." },
  ...
  // === Сабмишены и контроль (жаргон, дополнено по сверке словарей) ===
  { term: "Рычаг колена, книбар", en: "Kneebar", category: "attacks", definition: "Разгибание коленного сустава через свой таз как точку опоры. Из ножных сплетений; в BJJ по правилам разрешён с коричневого пояса." },
  { term: "Рычаг кисти, вристлок", en: "Wristlock", category: "attacks", definition: "Сгибание или скручивание запястья до сдачи. Быстрый и коварный сабмишн из многих контролей: работает точностью, а не силой." },
  { term: "Слайсер", en: "Slicer", category: "attacks", definition: "Ущемление мышцы (бицепса или икры) о свою кость или голень — резкая боль без скручивания сустава. Часто из контроля руки или ноги." },
  { term: "Боди-лок", en: "Body Lock", category: "control", definition: "Плотный обхват корпуса соперника сцепленными руками. Контроль для прохода, тейкдауна или удержания — забирает дистанцию и подвижность бёдер." },
  { term: "Гогоплата", en: "Gogoplata", category: "attacks", definition: "Удушение голенью, прижатой к горлу соперника, обычно из гарда или омоплаты. Требует гибкости, встречается редко." },
  { term: "Арм-треугол, голова-рука", en: "Arm Triangle", category: "attacks", definition: "Удушение головой и одной рукой соперника, зажатыми твоим плечом (ката-гатаме). Из маунта, сайда или север-юга: давит сонные его же плечом." },
  { term: "Бейсбол-чоук", en: "Baseball Choke", category: "attacks", definition: "Удушение накрест захваченными отворотами ги — руки как на бейсбольной бите. Из сайда, черепахи или при проходе." },
  { term: "Слэм", en: "Slam", category: "training", definition: "Бросок соперника об ковёр с высоты (например, из гарда). Запрещён правилами IBJJF — риск травмы позвоночника." },
];
