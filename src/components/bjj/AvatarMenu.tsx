...
import { X, Cloud, CloudOff, LogIn, LogOut, Info, ChevronRight, BarChart3, BookA } from "lucide-react";
    ...
    <div className="fixed inset-0 z-[60] flex items-end justify-center sm:items-center" role="dialog" aria-modal="true">
      ...
      <div className="relative z-10 flex max-h-[88vh] w-full max-w-xl flex-col overflow-hidden rounded-t-3xl border border-border bg-background shadow-2xl sm:rounded-3xl">
        ...
        <div className="flex-1 space-y-5 overflow-y-auto p-4">
          ...
          {/* Настройки: формат */}
          {/* Пояс, кимоно, голова и стиль игры живут в листе персонажа
              («Моя игра» -> тап по аватару, CharacterSheet) */}
          <section>
