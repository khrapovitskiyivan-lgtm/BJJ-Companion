...
const ABOUT = [
  ...
  "",
  "Логируешь тренировки — приложение видит твой стиль, считает план и подсказывает, что учить и что повторить. 293 техники от белого до чёрного пояса, готовые отработки с таймером, разбор ситуаций.",
  "",
