...
const WELCOME = [
  ...
  "",
  "Отмечай тренировки в дневнике, смотри свой стиль и прогресс, разбирай ситуации и получай рекомендации, что учить дальше. База: 329 приёмов и позиций от белого до чёрного пояса.",
  "",
  COMMANDS_HINT,
  "",
...
const ABOUT = [
  ...
  "",
  "Логируешь тренировки — приложение видит твой стиль, считает план и подсказывает, что учить и что повторить. 329 приёмов и позиций от белого до чёрного пояса, готовые отработки с таймером, разбор ситуаций.",
  "",
