    ...
    <AppShell>
      <div className="space-y-4">
        ...
        <Card
          ...
          title="Библиотека"
          text={`${total} приёмов и позиций: поиск, фильтры по поясу, разделу и Gi/No-Gi. У каждой карточки механика по шагам, ключевые моменты, типичные ошибки, дриллы, связанные и похожие техники. Отмечайте статус: «в процессе» — учите сейчас, «изучено» — уверенно работает в спарринге.`}
        />
        <Card
        ...
        <p className="px-1 text-[11px] leading-relaxed text-muted-foreground">
          База: {total} приёмов и позиций, проверена методическим аудитом — покрытие от самостраховки до современного
