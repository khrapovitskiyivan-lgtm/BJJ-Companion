...
const BLOCKS: Pos[][] = [
  ...
  [
    ...
    { name: "Коленный щит", play: { id: 381, verb: "Играю" }, vs: { id: 331, verb: "Прохожу" } },
    { name: "Локдаун", play: { id: 647, verb: "Играю" }, vs: { id: 685, verb: "Прохожу" } },
  ],
  ...
  [
    ...
    { name: "Боди-триангл", play: { id: 632, verb: "Держу" }, vs: { id: 679, verb: "Защита" } },
    { name: "Фронт-хедлок", play: { id: 610, verb: "Держу" }, vs: { id: 680, verb: "Защита" } },
  ],
  // Ножные позиции (сплетения — одна сторона)
  [
    { name: "Сингл Лег Икс", play: { id: 300, verb: "Атакую" }, vs: { id: 683, verb: "Защита" } },
    { name: "Аши-гарами", play: { id: 305, verb: "Атакую" }, vs: { id: 681, verb: "Защита" } },
    { name: "Задний аши-гарами", play: { id: 367, verb: "Атакую" }, vs: { id: 682, verb: "Защита" } },
    { name: "Седло (ханихол)", play: { id: 440, verb: "Атакую" }, vs: { id: 328, verb: "Защита" } },
    { name: "Бэксайд 50/50", play: { id: 635, verb: "Атакую" }, vs: { id: 684, verb: "Защита" } },
  ],
  // Стойка
